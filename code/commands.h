...
static const instruction COMMANDS[] = 
{
    ...
    CMD("HLT",  0b1000000, ass_halt, spu_halt, dis_def,  sizeof(COMMAND_TYPE)),

    CMD("ADD",  0b0000001, ass_add,  spu_add,  dis_def,  sizeof(COMMAND_TYPE)),
    CMD("SUB",  0b0000010, ass_sub,  spu_sub,  dis_def,  sizeof(COMMAND_TYPE)),  
    CMD("MUL",  0b0000011, ass_mul,  spu_mul,  dis_def,  sizeof(COMMAND_TYPE)),
    CMD("DIV",  0b0000100, ass_div,  spu_div,  dis_def,  sizeof(COMMAND_TYPE)),
    CMD("SQRT", 0b0000101, ass_sqrt, spu_sqrt, dis_def,  sizeof(COMMAND_TYPE)),
    
    CMD("PUSH", 0b0000110, ass_push, spu_push, dis_push, sizeof(COMMAND_TYPE) + sizeof(VALUE_TYPE)),
    CMD("IN",   0b0001000, ass_in,   spu_in,   dis_def,  sizeof(COMMAND_TYPE)),
    CMD("OUT",  0b0001001, ass_out,  spu_out,  dis_def,  sizeof(COMMAND_TYPE)),
